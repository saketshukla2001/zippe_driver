            ...
            child: Stack(
              children: [
                Container(
                  ...
                  width: media.width * 1,
                  color: (isDarkTheme && vehicledata.isEmpty)
                      ? Colors.black
                      : page,
                  //history details
                  child: Column(
                                                                  ...
                                                                  vehicledata[i]['approve']
                                                                      ...
                                                                      ? Center(
                                                                          child:
                                                                              Container(
                                                                            decoration:
                                                                                const BoxDecoration(shape: BoxShape.circle, image: DecorationImage(image: AssetImage('assets/images/approved.png'), opacity: 0.4, fit: BoxFit.contain)),
                                                                            height:
                                                                                media.width * 0.15,
                                                                            width:
                                                                                media.width * 0.15,
                                                                  ...
                                                                  Positioned(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              vehicledata[i]['driverDetail'] != null ? MyText(text: vehicledata[i]['driverDetail']['data']['name'].toString(), size: media.width * fourteen, fontweight: FontWeight.bold) : Container(),
                                                                              vehicledata[i]['driverDetail'] != null
                                                                                  ...
                                                                                  : Container(),
                                                                              MyText(text: vehicledata[i]['model'].toString(), size: media.width * fourteen, fontweight: FontWeight.bold),
                                                                              ...
                                                                              if (vehicledata[i]['driverDetail'] == null && vehicledata[i]['approve'].toString() == '0')
                                                                                Container(
                                                                                  alignment: Alignment.center,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    MenuClass(
                                                                      ontap:
                                                                        ...
                                                                        var nav = await Navigator.push(
                                                                            context,
                                                                            MaterialPageRoute(builder: (context) => FleetDocuments(fleetid: fleetid)));
                                                                        if (nav !=
                                                                            null) {
                                                                          if (nav) {
                                                                            setState(() {
