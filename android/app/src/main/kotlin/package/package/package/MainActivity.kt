...
val launchIntent = getPackageManager().getLaunchIntentForPackage("com.zippedriver.vr");
if (launchIntent != null) { 
    startActivity(launchIntent);//null pointer check in case com.zippedriver.vr was not found
}   }
